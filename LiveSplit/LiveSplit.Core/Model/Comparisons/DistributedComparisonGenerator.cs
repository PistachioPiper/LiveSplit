...
{
    public class DistributedComparisonGenerator : IComparisonGenerator
    {
        public IRun Run { get; set; }
        public const string ComparisonName = "Distributed PB";
        public const string ShortComparisonName = "Distributed";
        public string Name => ComparisonName;

        public DistributedComparisonGenerator(IRun run)
        {
            Run = run;
        }
