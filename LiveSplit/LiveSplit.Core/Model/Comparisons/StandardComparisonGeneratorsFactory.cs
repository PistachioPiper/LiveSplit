...
namespace LiveSplit.Model.Comparisons
{
    public class StandardComparisonGeneratorsFactory : IComparisonGeneratorsFactory
    {
        static StandardComparisonGeneratorsFactory()
        {
            ...
            AddShortComparisonName(SimpleDistributedComparisonGenerator.ComparisonName, DistributedComparisonGenerator.ShortComparisonName);
        }
        ...
        public IEnumerable<IComparisonGenerator> GetAllGenerators(IRun run)
        {
            ...
            yield return new SimpleDistributedComparisonGenerator(run);
            yield return new WorstSplitTimesComparisonGenerator(run);
