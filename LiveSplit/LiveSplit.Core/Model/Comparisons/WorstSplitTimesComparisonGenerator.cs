...
{
    public class WorstSplitTimesComparisonGenerator : IComparisonGenerator
    {
        public IRun Run { get; set; }
        public const string ComparisonName = "Worst Split Times";
        public string Name => ComparisonName;

        public WorstSplitTimesComparisonGenerator(IRun run)
        {
            Run = run;
        }
