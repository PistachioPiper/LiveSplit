...
namespace LiveSplit.UI.Components
{
    public class Timer : IComponent
    {
        ...
        protected ShortTimeFormatterMS Formatter { get; set; }
        ...
        public Timer()
        {
            ...
            Formatter = new ShortTimeFormatterMS();
        ...
        public void Update(IInvalidator invalidator, LiveSplitState state, float width, float height, LayoutMode mode)
        {
            ...
            if (timeValue != null)
            {
                ...
                if (CurrentAccuracy == TimeAccuracy.Tenths)
                ...
                else if (CurrentAccuracy == TimeAccuracy.Milliseconds)
